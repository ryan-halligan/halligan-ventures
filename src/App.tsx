...
import Training from "./pages/work/Training";
import Goals from "./pages/work/Goals";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/work/training" element={<Training />} />
          <Route path="/work/goals" element={<Goals />} />
