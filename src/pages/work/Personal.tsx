                  ...
                  <Link to="/work/training">
                    <Card className="border-border hover-lift cursor-pointer transition-all hover:border-gold relative overflow-hidden h-full">
                      ...
                      <CardContent className="p-6 text-center relative z-10 flex flex-col h-full min-h-[180px]">
                        ...
                        <p className="text-sm text-muted-foreground mb-4 flex-grow">PRs, metrics, race results, and current focus</p>
                        <ChevronRight className="mx-auto text-gold" size={24} />
                      </CardContent>
                    </Card>
                  </Link>
                  ...
                  <Link to="/work/goals">
                    <Card className="border-border hover-lift cursor-pointer transition-all hover:border-gold relative overflow-hidden h-full">
                      ...
                      <CardContent className="p-6 text-center relative z-10 flex flex-col h-full min-h-[180px]">
                        ...
                        <p className="text-sm text-muted-foreground mb-4 flex-grow">Achievements and what I'm chasing next</p>
                        <ChevronRight className="mx-auto text-gold" size={24} />
                      </CardContent>
                    </Card>
                  </Link>
